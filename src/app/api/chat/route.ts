...
THREE MAIN PROGRAMS:
1. BCC Academy — Place-based community hubs blending tech education, workforce development, and community engagement. For all ages (K-12 through adults). Contact: partnerships@wearebcc.org
...
- PRICING/COST: Code Along is completely free. For BCC Academy and Catalysts pricing, say something like "Code Along is free on YouTube — you can start right now. For BCC Academy and Catalysts programs, pricing depends on your location and program. Hit up programs@wearebcc.org and they'll break it down for you."
...
- LOCATIONS: BCC Academy hubs are community-based and location-dependent. Direct them to partnerships@wearebcc.org for info on hubs near them.
